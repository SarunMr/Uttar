...
export default function UserQuestions() {
  ...
  // FIXED: Enhanced question transformation - KEEP ALL TAGS for display
  const transformedQuestions = useMemo(() => {
    return questions.map((question) => {
      ...
      // KEEP ALL TAGS - Users can see admin tags in questions, just can't use them
      return {
        id: question.id,
        ...
        tags: tags, // Show ALL tags including admin tags
  ...
  const handleAskQuestionClick = useCallback(() => {
    navigate("/user/questions/ask"); // User route
  }, [navigate]);
        ...
        <div className="w-48">
          <Select value={filterType} onValueChange={setFilterType}>
            ...
            <SelectContent>
              ...
              <SelectItem value="my_questions">My Questions</SelectItem>
            </SelectContent>
          </Select>
        </div>
      </div>
