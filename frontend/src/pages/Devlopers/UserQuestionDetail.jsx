  ...
  const loadQuestionDetail = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        console.log("=== USER QUESTION DATA LOADED ===");
        ...
        console.log("=== END USER QUESTION DATA ===");
  ...
  if (error) {
    return (
      <div className="text-center py-16">
        ...
        <Button onClick={() => navigate("/user/questions")} className="mt-4">
          Back to Questions
        </Button>
      </div>
    );
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <Card className="mb-8">
        <CardHeader>
          ...
          {/* Tags Section - Shows ALL tags including admin */}
